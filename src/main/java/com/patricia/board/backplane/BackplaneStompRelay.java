 ...
 * llegar un mensaje, lo reenvia a su broker STOMP local. Los clientes de
 * este pod que esten suscritos al destino lo reciben; en los demas pods
 * ocurre lo mismo con sus propios clientes.
 */
@Slf4j
